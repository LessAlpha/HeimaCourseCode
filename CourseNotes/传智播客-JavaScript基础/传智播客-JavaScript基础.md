...
- 数值判断
  ...
  - NaN：not a number
    - NaN 与任何值都不相等，包括他本身
  - isNaN(): is not a number 判断是否是NaN数据类型
...
1. undefined表示一个声明了没有赋值的变量（包括一个对象未声明的属性变量），变量只声明的时候值默认是undefined
...
![06-1](D:/StepsFullStack/AANotes/%E5%89%8D%E7%AB%AF%E5%9F%BA%E7%A1%80/%E4%BC%A0%E6%99%BA%E6%92%AD%E5%AE%A2-JavaScript%E5%9F%BA%E7%A1%80/media/06-1.png)
...
![06-2](D:/StepsFullStack/AANotes/%E5%89%8D%E7%AB%AF%E5%9F%BA%E7%A1%80/%E4%BC%A0%E6%99%BA%E6%92%AD%E5%AE%A2-JavaScript%E5%9F%BA%E7%A1%80/media/06-2.png)
...
var a = 25;
function abc (){
  alert(a);//undefined，因为先在该函数作用域内搜寻变量a
  var a = 10;
}
abc();
// 如果变量和函数同名的话，函数优先
...
- 变量提升
  ...
  定义变量的时候，变量的声明会被提升到作用域的最上面，变量的**赋值不会提升**。
...
- 函数提升
  ...
  1. 预解析会分段(多对的script标签中函数重名,预解析的时候不会冲突)
  2. 函数中的变量只会提前到函数的作用域中的最前面,不会出去
